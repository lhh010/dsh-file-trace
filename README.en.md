...
```sh
# Option 1: pinned-tag git dependency (public mirror, recommended; github:omdsh-dev/dsh-file-trace also works)
dsh plugin --profile web add '@dsh-external/dsh-file-trace@github:omdsh-dev/dsh-file-trace#v0.3.10'
...
> 1. Run `dsh plugin --profile web add '@dsh-external/dsh-file-trace@github:omdsh-dev/dsh-file-trace#v0.3.10'` (the first run may fail because pnpm 11 blocks node-pty build scripts)
