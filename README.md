...
> 兼容 DSH `dsh-v0.1.2-alpha.3`（typecheck/build + 73 单测全绿，实机验证；本插件基于 alpha.1+ 编写，rc.2 下无可用版本）
...
> 1. 执行 `dsh plugin --profile web add '@dsh-external/dsh-file-trace@github:dsh-external/dsh-file-trace#v0.2.2'`（首次可能被 pnpm 11 拦截 node-pty 构建脚本而失败）
...
| 插件版本 | DSH 版本 | 说明 |
| --- | --- | --- |
| `v0.2.2`（默认） | `dsh-v0.1.2-alpha.1`~`alpha.3` | 高亮扩充（mjs/cjs/mts/cts、CSS/SCSS/Less、HTML/XML/SVG/Vue、GraphQL、JSONC/JSON5）+ Ctrl+滚轮分区调字号（9–28px，边界提示） |
